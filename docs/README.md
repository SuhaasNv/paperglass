...
| `03-architecture/` | `ARCHITECTURE.md`, `VIEWS.md`, `FINDING_SCHEMA.md`, `TECHNIQUE_REGISTRY.md`, `SANDBOX.md`, `decisions/` (ADR-001 to ADR-006), `diagrams/` | written; diagrams to be written (US-000, US-081) |
| `04-report-design/` | `REPORT_DESIGN.md`, `CLI_DESIGN.md`, `ACCESSIBILITY.md` | written |
...
| `09-testing/` | `TEST_STRATEGY.md`, `FIXTURES.md` | written |
| `10-operations/` | `BRANCHING.md`, `OPERATIONS.md`, `RELEASE_CHECKLIST.md` | written; `OPERATIONS.md` grows per story |
